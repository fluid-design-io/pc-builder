    ...
    >
      ...
      <main style={{ display: "flex", justifyContent: "center" }}>
        <section>
          ...
          <p>
            Keystone's APIs can be seamlessly composed to work as a powerful
            data engine within Next.js applications without having to host a
            separate Keystone server. This is made possible by Keystone&apos;s
            `getContext` API.
          </p>
          <ul>
            <li>
